...
const ProjectCard = ({ project }: { project: Project }) => {
  return (
    <div className="flex flex-col justify-between rounded-2xl h-full text-justify border overflow-hidden w-full max-w-md shadow-md bg-black text-white">
      {/* Project Details */}
      ...
      <div className="p-5 pt-0 flex flex-col gap-5">
        ...
        <Link
          href={project.link}
          className="flex items-center gap-2 text-white hover:underline text-sm lg:text-md"
          target="_blank"
